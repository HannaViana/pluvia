"""
Chart 18: Rainfall Peak Intensity vs Duration with API Thresholds — Per Sub-bacia
One figure per sub-bacia showing EA/ESA scatter with upper and lower tolerance
thresholds. Mirrors chart 16 but uses per-sub-bacia fitted parameters.
"""
...
def create_id_threshold_chart_for_subbacia(shi_cd, shi_nm, subbacia_events, subbacia_params):
    ...
    fig.suptitle(f'Rainfall Peak Intensity vs Duration Thresholds — {title_name}\n'
...
def main():
    print("=" * 70)
    print("CHART 18: API-BASED I-D THRESHOLDS PER SUB-BACIA")
    print("=" * 70)
    ...
    chart_output_dir = f'{OUTPUT_DIR}/chart_18_api_id_thresholds_per_subbacia'
    ...
    for shi_cd in subbacia_ids:
        try:
            ...
            fig = create_id_threshold_chart_for_subbacia(shi_cd, shi_nm, subbacia_events, subbacia_params)
